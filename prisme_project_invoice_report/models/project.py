...
class prisme_project_print_financial_view(models.Model):
    ...
    def print_project_financial_view(self, print_lines_not_invoiced, print_lines_not_invoiced_up_to):
        #Save the value from the wizard
        self.write({'print_lines_not_invoiced': print_lines_not_invoiced, 'print_lines_not_invoiced_up_to': print_lines_not_invoiced_up_to})
